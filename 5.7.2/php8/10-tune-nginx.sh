...
ExecStartPost=-/usr/lib/php/php-fpm-socket-helper install /run/php/php-fpm.sock /etc/php/8.0/fpm/pool.d/www.conf 74
ExecStopPost=-/usr/lib/php/php-fpm-socket-helper remove /run/php/php-fpm.sock /etc/php/8.0/fpm/pool.d/www.conf 74
...
cat >"/etc/php/8.0/fpm/conf.d/40-memcached.ini" << EOF
extension=memcached.so
EOF

cat >"/etc/php/8.0/cli/conf.d/40-memcached.ini" << EOF
extension=memcached.so
EOF
